...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyAdapter(Context context, ArrayList name, ArrayList email, ArrayList password, ArrayList phone, ArrayList address) {
    ...
    public MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adminapplicantlist, parent, false);
