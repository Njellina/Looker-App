...
public class MyAdapter6 extends RecyclerView.Adapter<MyAdapter6.MyViewHolder> {
    ...
    public MyAdapter6(Context context, ArrayList id, ArrayList category, ArrayList city, ArrayList description, ArrayList salary) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyAdapter6.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView category, description, id, city, salary;
