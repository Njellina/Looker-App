...
public class AdminSDApplicant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adminsdapplicant);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.isEmpty()){
                    Toast.makeText(AdminSDApplicant.this, "Please enter the email!", Toast.LENGTH_SHORT).show();
                }
                else{
                    try{
                        Cursor cursor = db.searchApplicant(email);
                        if (cursor.moveToFirst()){
                            ...
                            Toast.makeText(AdminSDApplicant.this, "Email not found!", Toast.LENGTH_SHORT).show();
